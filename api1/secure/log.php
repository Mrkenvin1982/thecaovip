          ...
          <div class="col-md-6">  
                  <div class='col-md-4'>
                            <div class="form-group">
                                    ...
                                    <input type='text' class="form-control" value="" name="target"/>
...
<option value="3">Lỗi port</option>
<option value="4">Hệ thống bận</option>
<option value="5">Quá 5 lần</option>
 ...
 $('#btn-search').html("Xin mời chờ...<img src='data:image/gif;base64,' />");
    ...
    success: function (data) {
        ...
        $("#btn-search").html('<button onclick="load(1)" class="btn btn-primary">Search</button>');
    }
  });
        }
    </script>
