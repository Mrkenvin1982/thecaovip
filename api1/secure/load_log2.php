...
$list = $models_logcards->customQuery("SELECT * FROM LogCards WHERE id > 54264 AND time BETWEEN $start_limit AND $end_limit AND msg NOT like '%thanh toan thanh cong cho thue bao%' and msg NOT like '%uy khach da nap thanh cong%' ORDER BY id DESC");
?>
