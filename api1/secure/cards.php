...
$modemls_cards = new Models_Cards();
$list = $modemls_cards->customFilter('', array('time' => array($start_limit, '>=')));
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="row">
                    <form id="fsearch">
                        ...
                        <div class='col-md-3'>
                            <input type='text' class="form-control" name="seri" placeholder="Nhap Seri..."/>
                        </div>
