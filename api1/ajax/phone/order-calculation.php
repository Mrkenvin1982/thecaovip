...
$default_discount = $models_default->getLastObject()->discount;
 ...
 $array_discount[1] = $array_discount[2]=$array_discount[4]=$array_discount[3]=$default_discount;
...
$standard_total = $price-$discount_money;
   echo json_encode(array('code' => 0, 'standard_total'=> number_format($standard_total)));
        exit();